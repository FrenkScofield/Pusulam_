...
(function ($, undefined) {
    ...
    var defaults = {
        ...
        isRTL: false,
        firstDay: 1,
        monthNames: ['Ocak', '&#350;ubat', 'Mart', 'Nisan', 'May&#305;s', 'Haziran', 'Temmuz', 'A&#287;ustos', 'Eyl&uuml;l', 'Ekim', 'Kas&#305;m', 'Aral&#305;k'],
        monthNamesShort: ['Oca', '&#350;ub', 'Mar', 'Nis', 'May', 'Haz', 'Tem', 'Agu', 'Eyl', 'Eki', 'Kas', 'Ara'],
        dayNames: ['Pazar', 'Pazartesi', 'Sal&#305;', '&#231;ar&#350;amba', 'Per&#350;embe', 'Cuma', 'Cumartesi'],
        dayNamesShort: ['Paz', 'Pts', 'Sal', 'Car', 'Per', 'Cum', 'Cts'],
        buttonText: {
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                element = $("<table class='fc-header'  style='width:100%; height:58px; background-color:#4b8df8'/>")
				.append(
					$("<tr/>")
            ...
            if (buttonStr) {
                $.each(buttonStr.split(' '), function (i) {
                    ...
                    $.each(this.split(','), function (j, buttonName) {
                        if (buttonName == 'title') {
                            e.append("<span class='fc-header-title'><h2 style=' padding:7px; color:#FFF;'>&nbsp;</h2></span>");
                            if (prevButton) {
    ...
    */
    ...
    function AgendaEventRenderer() {
        ...
        function slotSegHtml(event, seg) {
            ...
            html +=
			" class='" + classes.join(' ') + "' id='Event" + event.id + "'" +
			...
			htmlEscape(JSON.stringify(event.title.replace("/&#39;/g", "'"))) +
			"</div>" +
			"</div>" +
    ...
    function DayEventRenderer() {
        ...
        function daySegHTML(segs) { // also sets seg.left and seg.outerWidth
            ...
            for (i = 0; i < segCnt; i++) {
                ...
                html +=
				"<span class='fc-event-title'>" + htmlEscape(JSON.stringify(event.title.replace("/&#39;/g", "'"))) + "</span>" +
				"</div>";
                if (seg.isEnd && isEventResizable(event)) {
                    html +=
