...
{
    public partial class UniteTaramaSinifMaddeAnalizi : DevExpress.XtraReports.UI.XtraReport
    {
        #region tanımlamalar
        ...
        int islem = 1;
        #endregion
        public UniteTaramaSinifMaddeAnalizi(string tc, string oturum, string donem,string idKademe3,string idSinavList, string idSubeList, string idDersList)
        {
            TCKIMLIKNO = tc;
            OTURUM = oturum;
            OGRENCIDONEM = donem;
        ...
        private void UniteTaramaSinifMaddeAnalizi_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            using (Baglanti b = new Baglanti())
            {
                ...
                b.ParametreEkle("@ISLEM", 34); // Rapor
                b.ParametreEkle("@ID_MENU", 1300);
                ds = b.SorguGetir("sp_UniteTarama");
        ...
        public void Baslik()
        {
            ...
            ReportHeader.Controls.Add(lblEkle("", LX, LY, lblEn * 2, lblBoy, backColor, foreColor, borderColor));
        ...
        public void Icerik()
        {
            ...
            foreach (DataRow veri in sortedDT.Rows)
            {
                ...
                else
                {
                    ...
                    Detail.Controls.Add(lblEkle(veri["SORUNO"].ToString(), LX, LY, lblEn, lblBoy, backColor, foreColor, borderColor));
                ...
                foreach (DataRow dr in TblSinif.Rows)
                {
                    ...
                    if (veri["SORUNO"].ToString() == "0") clr = Color.Yellow;
