...
{
    public partial class UniteTaramaPuanRapor : DevExpress.XtraReports.UI.XtraReport
    {
        string TCKIMLIKNO;
        string OTURUM;
        string ID_UNITETARAMASINAV;
        string DONEM;
        string ID_SUBE;
        string ID_SINIF;
        ...
        public UniteTaramaPuanRapor(string TCKIMLIKNO, string OTURUM, string ID_UNITETARAMASINAV, string DONEM, string ID_SUBE, string ID_SINIF)
        {
        ...
        private void UniteTaramaPuanRapor_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
