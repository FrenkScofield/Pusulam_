...
{
    public partial class GelisimRaporuLS : XtraReport
    {
        #region tanımlamalar
        ...
        public GelisimRaporuLS(DataSet ds, string tC, string dONEM, string rAPORTURLIST, string oTURUM)
        {
            InitializeComponent();
            ...
            //{
            pbOn.ImageUrl = HttpContext.Current.Server.MapPath("/Dosyalar/GelisimRaporuLS/Kapak/onL.png");
            pbArka.ImageUrl = HttpContext.Current.Server.MapPath("/Dosyalar/GelisimRaporuLS/Kapak/arkaL.png");
            //}
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Array.IndexOf(rAPORTURLIST, "2") >= 0 || Array.IndexOf(rAPORTURLIST, "3") >= 0)//Yazılı Yoklama Sonuçları
            {
                ...
                if (ds.Tables[index + 1].Select("TCKIMLIKNO='" + tC + "'").Length > 0)
                {
                    ...
                    string path = HttpContext.Current.Server.MapPath("/Dosyalar/GelisimRaporuLS/Temp/" + OTURUM + "/" + "yazili-" + tC + ".png");
            ...
            if (Array.IndexOf(rAPORTURLIST, "4") >= 0)//Deneme Sonuçları
            {
                ...
                if (ds.Tables[index].Select("TCKIMLIKNO='" + tC + "'").Length > 0)
                {
                    ...
                    foreach (DataRow item in temptable.DefaultView.ToTable(true, "ID_SINAVTURU").Rows)
                    {
                        ...
                        XtraReport newReport = new XtraReport();
                        Directory.CreateDirectory(HttpContext.Current.Server.MapPath("/Dosyalar/GelisimRaporuLS/Temp/" + OTURUM + ""));
                        string path = HttpContext.Current.Server.MapPath("/Dosyalar/GelisimRaporuLS/Temp/" + OTURUM + "/" + item["ID_SINAVTURU"] + "-ds-" + tC + ".png");
