...
{
    public partial class OR_SinifPuanListesi : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public OR_SinifPuanListesi(DataTable _dt1, DataTable _dt2, DataTable _dt3, DataTable _dtKATILIM, string _SUBEAD, string _SUBEIL, string _SUBEILCE, string _SINAVAD, List<string> _dersKisa, List<string> _dersUzun)
        {
            dersKisa = _dersKisa;
            dersUzun = _dersUzun;
            dt1 = _dt1;
        ...
        private void OR_SinifPuanListesi_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void GroupFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            DataTable distinctValuesy = dt3.Select("SINIF='" + GetCurrentColumnValue("SINIF").ToString() + "'").CopyToDataTable();
            foreach (DataRow item in distinctValuesy.Rows)
            {
                ssinif.Points.Add(new SeriesPoint(item["KOD"].ToString(), Convert.ToDouble(item["PUAN"].ToString())));
                ssinif.LabelsVisibility = DevExpress.Utils.DefaultBoolean.False;
            }
            xr_puankar.Series.Add(ssinif);
            ((XYDiagram)xr_puankar.Diagram).DefaultPane.BackColor = Color.White;
            ((XYDiagram)xr_puankar.Diagram).DefaultPane.FillStyle.FillMode = FillMode.Solid;
        }

        private void GroupHeader1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            string SINIF = GetCurrentColumnValue("SINIF").ToString();
            TITLE.Text = SINIF + " SINIFI PUAN LİSTESİ";
        }
    }
}
