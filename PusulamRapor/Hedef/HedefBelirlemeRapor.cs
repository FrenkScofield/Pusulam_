...
{
    public partial class HedefBelirlemeRapor : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public HedefBelirlemeRapor(string tc, string oturum, string idSubeList, string idSinifList)
        {
            TCKIMLIKNO = tc;
            OTURUM = oturum;
        ...
        private void HedefBelirlemeRapor_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
