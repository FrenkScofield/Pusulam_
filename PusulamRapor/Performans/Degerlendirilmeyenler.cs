...
{
    public partial class Degerlendirilmeyenler : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public Degerlendirilmeyenler(string tc, string oturum, string id_Periyot)
        {
            TCKIMLIKNO = tc;
            OTURUM = oturum;
        ...
        private void Degerlendirilmeyenler_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
