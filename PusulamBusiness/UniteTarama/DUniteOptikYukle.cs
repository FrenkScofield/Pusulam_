...
namespace PusulamBusiness.UniteTarama
{
    public class DUniteOptikYukle : DBase
    {
        ...
        public int DosyaKaydet(JObject j)
        {
            try
            {
                j.Add("ISLEM", (int)sp_UniteTaramaOptik.DosyaKaydet);
                j.Add("ID_MENU", ID_MENU);
                j.Add("IP", getIp.GetUser_IP());
        ...
        public bool OptikBelliMi(JObject j)
        {
            try
            {
                j.Add("ISLEM", (int)sp_UniteTaramaOptik.OptikBelliMi);
                j.Add("ID_MENU", ID_MENU);
                j.Add("IP", getIp.GetUser_IP());
