...
{
    public class DKullaniciYetkiIslemleri : DBase
    {
        ...
        public string Listele(JObject j)
        {
            try
            {
                j.Add("ISLEM", (int)sp_KullaniciArama.OgrenciListele);
        ...
        public string BransListele(JObject j)
        {
            try
            {
                j.Add("ISLEM", (int)sp_KullaniciArama.Brans);
                j.Add("ID_MENU", ID_MENU);
                j.Add("IP", getIp.GetUser_IP());
        ...
        public string YetkiKaldir(JObject j)
        {
            try
            {
                j.Add("ISLEM", (int)sp_KullaniciArama.YetkiKaldir);
                j.Add("ID_MENU", ID_MENU);
                j.Add("IP", getIp.GetUser_IP());
