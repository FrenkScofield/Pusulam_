USE [Pusulam]
GO
/****** Object:  StoredProcedure [dbo].[sp_Menu]    Script Date: 2.06.2021 09:42:46 ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN
		...
		BEGIN	
			...
			BEGIN						
				...
				WHERE OS.AKTIF = 1 AND os.ID_OZELSAYFA=75			
...
USE [Pusulam]
GO
/****** Object:  StoredProcedure [dbo].[sp_Odev]    Script Date: 2.06.2021 09:38:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
