...
/****** Object:  StoredProcedure [dbo].[sp_Sinav]    Script Date: 13.02.2021 16:06:28 ******/
SET ANSI_NULLS ON
GO
...
*/
			...
			END
				...
				BEGIN
				DECLARE @JSONRESULTDATA NVARCHAR(MAX)=''
				
				DROP TABLE IF EXISTS #TEMP_LOG_LIST
					SELECT   
				...
				SET @JSONRESULTDATA=(SELECT * FROM #TEMP_LOG_LIST FOR JSON AUTO)

				SELECT @JSONRESULTDATA
				END
