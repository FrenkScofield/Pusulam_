...
VALUES ('Öğrenci Sınav Takip',	'Öğrenci Sınav Takip',	'005999008'	,'#OnlineSinav/OgrenciSinavTakip','icon-list')

GO


CREATE procedure [dbo].[sp_FiltreEk]
	@ISLEM			INT				= NULL,
...
CREATE PROC [dbo].[sp_OnlineSinav]
	@ISLEM							INT				= NULL,
	@TCKIMLIKNO						VARCHAR(11)		= NULL,
	@OTURUM							VARCHAR(36)		= NULL,
	@ID_MENU						INT				= NULL,
