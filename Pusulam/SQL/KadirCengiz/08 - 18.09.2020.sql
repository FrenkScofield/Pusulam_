...
CREATE TABLE [dbo].[Parametre] (
    ...
    [ID_PARAMETREGRUP]  INT            NOT NULL,
    [ID_PARAMETREDEGER] INT            NULL,
    [AD]                NVARCHAR (MAX) NOT NULL,
    CONSTRAINT [PK_Parametre] PRIMARY KEY CLUSTERED ([ID_PARAMETRE] ASC)
);


GO
PRINT N'Creating [dbo].[ParametreDeger]...';


GO
CREATE TABLE [dbo].[ParametreDeger] (
    [ID_PARAMETREDEGER] INT            IDENTITY (1, 1) NOT NULL,
    [ID_PARAMETREGRUP]  INT            NOT NULL,
    [DEGER]             NVARCHAR (MAX) NOT NULL,
    [AD]                NVARCHAR (MAX) NOT NULL,
    CONSTRAINT [PK_ParametreDeger] PRIMARY KEY CLUSTERED ([ID_PARAMETREDEGER] ASC)
);


GO
PRINT N'Creating [dbo].[ParametreGrup]...';


GO
CREATE TABLE [dbo].[ParametreGrup] (
    [ID_PARAMETREGRUP] INT            IDENTITY (1, 1) NOT NULL,
    [AD]               NVARCHAR (MAX) NOT NULL,
    CONSTRAINT [PK_ParametreGrup] PRIMARY KEY CLUSTERED ([ID_PARAMETREGRUP] ASC)
);


GO
PRINT N'Creating [dbo].[FK_Parametre_ParametreGrup]...';


GO
ALTER TABLE [dbo].[Parametre] WITH NOCHECK
    ADD CONSTRAINT [FK_Parametre_ParametreGrup] FOREIGN KEY ([ID_PARAMETREGRUP]) REFERENCES [dbo].[ParametreGrup] ([ID_PARAMETREGRUP]);


GO
PRINT N'Creating [dbo].[FK_Parametre_ParametreDeger]...';


GO
ALTER TABLE [dbo].[Parametre] WITH NOCHECK
    ADD CONSTRAINT [FK_Parametre_ParametreDeger] FOREIGN KEY ([ID_PARAMETREDEGER]) REFERENCES [dbo].[ParametreDeger] ([ID_PARAMETREDEGER]);


GO
PRINT N'Creating [dbo].[FK_ParametreDeger_ParametreGrup]...';


GO
ALTER TABLE [dbo].[ParametreDeger] WITH NOCHECK
    ADD CONSTRAINT [FK_ParametreDeger_ParametreGrup] FOREIGN KEY ([ID_PARAMETREGRUP]) REFERENCES [dbo].[ParametreGrup] ([ID_PARAMETREGRUP]);
	...
	BEGIN TRY    
		...
		BEGIN
			...
			BEGIN
				...
				SET @QUERY = (SELECT DEGER FROM Parametre P JOIN ParametreDeger PD ON PD.ID_PARAMETREDEGER = P.ID_PARAMETREDEGER WHERE P.ID_PARAMETRE = 7) -- Öğrenci Online Sınav Listesi
...
END
GO
PRINT N'Creating [dbo].[sp_Parametre]...';


GO
CREATE procedure [dbo].[sp_Parametre]
	@ISLEM					INT				= NULL,
	@TCKIMLIKNO				VARCHAR(11)		= NULL,
	@OTURUM					VARCHAR(36)		= NULL,
	@ID_MENU				INT				= NULL,
...
GO
ALTER TABLE [dbo].[Parametre] WITH CHECK CHECK CONSTRAINT [FK_Parametre_ParametreGrup];

ALTER TABLE [dbo].[Parametre] WITH CHECK CHECK CONSTRAINT [FK_Parametre_ParametreDeger];

ALTER TABLE [dbo].[ParametreDeger] WITH CHECK CHECK CONSTRAINT [FK_ParametreDeger_ParametreGrup];
