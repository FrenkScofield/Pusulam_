		...
		BEGIN			
			...
			BEGIN
				...
				(
					...
					WHERE MD.TC_ALAN = @TCKIMLIKNO AND MD.SIL = 0 AND MD.TC_GONDEREN = '99999999999' AND NOT EXISTS (SELECT * FROM OkyanusDB.dbo.v3Ogrenci O WHERE O.TCKIMLIKNO = MD.TC_ALAN )
