...
/****** Object:  Table [dbo].[OdevTamamlandi]    Script Date: 13.10.2020 10:46:10 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[OdevTamamlandi](
	[ID_ODEVTAMAMLANDI] [int] IDENTITY(1,1) NOT NULL,
	[ID_ODEV] [int] NOT NULL,
	[TCKIMLIKNO] [varchar](11) NOT NULL,
 CONSTRAINT [PK_OdevTamamlandi] PRIMARY KEY CLUSTERED 
(
	[ID_ODEVTAMAMLANDI] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
GO

ALTER TABLE [dbo].[OdevTamamlandi]  WITH CHECK ADD  CONSTRAINT [FK_OdevTamamlandi_Odev] FOREIGN KEY([ID_ODEV])
REFERENCES [dbo].[Odev] ([ID_ODEV])
ON UPDATE CASCADE
ON DELETE CASCADE
GO

ALTER TABLE [dbo].[OdevTamamlandi] CHECK CONSTRAINT [FK_OdevTamamlandi_Odev]
GO

USE [Pusulam]
GO
/****** Object:  StoredProcedure [dbo].[sp_Odev]    Script Date: 12.10.2020 14:50:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
