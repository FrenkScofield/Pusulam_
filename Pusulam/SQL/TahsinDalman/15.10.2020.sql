...
EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPaneCount' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO

EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane2' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO

EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO

/****** Object:  View [dbo].[vw_Soru]    Script Date: 15.10.2020 10:23:30 ******/
DROP VIEW [dbo].[vw_Soru]
GO
...
CREATE VIEW [dbo].[vw_Soru]
AS
SELECT DISTINCT 
                         dbo.Soru.ID_SORU, dbo.Soru.ID_USTSORU, dbo.Soru.ID_SORUTUR, VarlikSoruTur.AD AS SORUTUR, dbo.SoruDetay.KOD, dbo.SoruDetay.ID_SINAVGRUP, dbo.Kademe3.AD AS SINAVGRUP, dbo.SoruDetay.ID_DERS, 
                         dbo.Ders.AD AS DERSAD, dbo.SoruDetay.UNITE, dbo.SoruDetay.ID_ZORLUKTUR, VarlikZorlukTur.AD AS ZORLUKTUR, dbo.SoruHareket.ID_HAREKETDURUM, VarlikHareketTur.AD AS HAREKETDURUM, 
                         dbo.SoruDetay.KYE_KULLANICI, v3Kullanici_1.AD + ' ' + v3Kullanici_1.SOYAD AS KULLANICIAD, dbo.SoruDetay.KYE_TARIH, dbo.SoruDetay.SILINDI, VarlikSoruDuzey.SIRANO AS ID_SORUDUZEY
FROM            dbo.Soru INNER JOIN
                         dbo.SoruDetay ON dbo.Soru.ID_SORU = dbo.SoruDetay.ID_SORU INNER JOIN
                         dbo.SoruHareket ON dbo.Soru.ID_SORU = dbo.Soru.ID_SORU INNER JOIN
                         dbo.v3Kullanici AS v3Kullanici_1 ON dbo.SoruDetay.KYE_KULLANICI = v3Kullanici_1.TCKIMLIKNO LEFT OUTER JOIN
                         dbo.Ders ON dbo.SoruDetay.ID_DERS = dbo.Ders.ID_DERS LEFT OUTER JOIN
                         dbo.Kademe3 ON dbo.SoruDetay.ID_SINAVGRUP = dbo.Kademe3.ID_KADEME3 LEFT OUTER JOIN
                         dbo.Varlik AS VarlikSoruTur ON dbo.Soru.ID_SORUTUR = VarlikSoruTur.ID_VARLIK LEFT OUTER JOIN
                         dbo.Varlik AS VarlikZorlukTur ON dbo.SoruDetay.ID_ZORLUKTUR = VarlikZorlukTur.ID_VARLIK LEFT OUTER JOIN
                         dbo.Varlik AS VarlikHareketTur ON dbo.SoruHareket.ID_HAREKETDURUM = VarlikHareketTur.ID_VARLIK LEFT OUTER JOIN
                         dbo.Varlik AS VarlikSoruDuzey ON dbo.SoruDetay.ID_SORUDUZEY = VarlikSoruDuzey.ID_VARLIK
WHERE        (dbo.SoruHareket.ID_HAREKET =
                             (SELECT        MAX(ID_HAREKET) AS Expr1
                               FROM            dbo.SoruHareket AS SoruHareket_1
                               WHERE        (ID_SORU = dbo.Soru.ID_SORU))) AND (dbo.SoruDetay.SILINDI = 0)
GO
      ...
      Begin Tables = 
         ...
         Begin Table = "VarlikSoruTur"
            Begin Extent = 
               ...
               Right = 738
            End
            Display' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPane2', @value=N'Flags = 280
            TopColumn = 0
         End
         Begin Table = "VarlikZorlukTur"
            Begin Extent = 
               Top = 10
               Left = 300
               Bottom = 123
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'vw_Soru'
GO


USE [Pusulam]
GO
/****** Object:  StoredProcedure [dbo].[sp_Sinav]    Script Date: 15.10.2020 12:26:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
