...
{
    [GzipCompression]
    public class AbideSinavTanimlaController : ApiController
    {
        internal int ID_MENU = (int)EMenu.AbideSinavTanimla;
        ...
        public Object SinavTanimla(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DAbide.SinavTanimla(j);
                }
            }
            catch (Exception ex)
            {
        ...
        public Object SinavListele(JObject j)
        {
            try
            {
                using (Channel2<DAbide> c = new Channel2<DAbide>(ID_MENU))
                {
        ...
        public Object SinavDuzenle(JObject j)
        {
            try
            {
                ...
                {
                    c.DAbide.ID_MENU = ID_MENU;
                    return c.DAbide.SinavDuzenle(j);
                }
            }
            catch (Exception ex)
            {
        ...
        public Object OVGorsunDegistir(JObject j)
        {
            try
            {
                ...
                {
                    c.DAbide.ID_MENU = ID_MENU;
                    return c.DAbide.OVGorsunDegistir(j);
                }
            }
            catch (Exception ex)
            {
        ...
        public Object BildirimListele(JObject j)
        {
            try
            {
                ...
                {
                    c.DAbide.ID_MENU = ID_MENU;
                    return c.DAbide.BildirimListele(j);
                }
            }
            catch (Exception ex)
            {
