...
{
    [GzipCompression]
    public class SoruEkleController : ApiController
    {
        internal int ID_MENU = (int)EMenu.UpgradeSoruEkle;
        public Object SoruEkle(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DUpgradeSoru.SoruEkle(j);
                }
            }
            catch (Exception ex)
            {
