...
{
    [GzipCompression]
    public class KazanimAnaliziOOController : ApiController
    {
        internal int ID_MENU = (int)EMenu.KazanimAnaliziOO;

        public Object KazanimAnaliziOO(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DKazanimAnaliziOO.ID_MENU = ID_MENU;
                    return c.DKazanimAnaliziOO.KazanimAnaliziOO(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object OrtalamaListesiYeni(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DOrtalamaListesi.OrtalamaListesiYeni(j);
                }
            }
            catch (Exception)
            {
