...
{
    [GzipCompression]
    public class LUSRaporuController : ApiController
    {
        internal int ID_MENU = (int)EMenu.LUSRaporu;
        ...
        public Object YaziliYoklamaSinifSinavListesiKOS(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DYaziliYoklama.YaziliYoklamaSinifSinavListesiKOS(j);
                }
            }
            catch (Exception)
            {
