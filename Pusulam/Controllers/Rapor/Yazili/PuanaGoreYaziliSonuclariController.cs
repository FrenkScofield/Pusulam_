...
{
    [GzipCompression]
    public class PuanaGoreYaziliSonuclariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.PuanaGoreYaziliSonuclari;

        public Object PuanaGoreYaziliSonuclari(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DPuanaGoreYaziliSonuclari.ID_MENU = ID_MENU;
                    return c.DPuanaGoreYaziliSonuclari.PuanaGoreYaziliSonuclari(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object PuanaGoreYaziliSonuclariYeni(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DPuanaGoreYaziliSonuclari.ID_MENU = ID_MENU;
                    return c.DPuanaGoreYaziliSonuclari.PuanaGoreYaziliSonuclariYeni(j);
                }
            }
            catch (Exception)
            {
