...
{
    [GzipCompression]
    public class KazanimAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.KazanimAnalizi;

        public Object KazanimAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DKazanimAnalizi.ID_MENU = ID_MENU;
                    return c.DKazanimAnalizi.KazanimAnalizi(j);
                }
            }
            catch (Exception)
            {
