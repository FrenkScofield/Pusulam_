...
{
    [GzipCompression]
    public class SinavAnalizController : ApiController
    {
        internal int ID_MENU = (int)EMenu.SinavAnaliz;

        public Object SinavAnaliz(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinavAnaliz.ID_MENU = ID_MENU;
                    return c.DSinavAnaliz.SinavAnaliz(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavAnalizYeni(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinavAnaliz.ID_MENU = ID_MENU;
                    return c.DSinavAnaliz.SinavAnalizYeni(j);
                }
            }
            catch (Exception)
            {
