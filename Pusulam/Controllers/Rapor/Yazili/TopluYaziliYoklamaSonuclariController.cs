...
{
    [GzipCompression]
    public class TopluYaziliYoklamaSonuclariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.TopluYaziliYoklamaSonuclari;

        public Object TopluYaziliYoklamaSonuclari(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DTopluYaziliYoklamaSonuclari.TopluYaziliYoklamaSonuclari(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object TopluYaziliYoklamaSonuclariYeni(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DTopluYaziliYoklamaSonuclari.ID_MENU = ID_MENU;
                    return c.DTopluYaziliYoklamaSonuclari.TopluYaziliYoklamaSonuclariYeni(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object YaziliYoklamaSinavListesi(JObject j)
        {
            try
            {
                ...
                {
                    c.DTopluYaziliYoklamaSonuclari.ID_MENU = ID_MENU;
                    return c.DTopluYaziliYoklamaSonuclari.YaziliYoklamaSinavListesi(j);
                }
            }
            catch (Exception)
            {
