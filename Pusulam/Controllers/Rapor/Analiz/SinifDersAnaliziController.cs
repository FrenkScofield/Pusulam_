...
{
    [GzipCompression]
    public class SinifDersAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.SinifDersAnalizi;
        public Object SinifDersAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinavAnalizi.SinifDersAnalizi(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavListele(JObject j)
        {
            try
            {
                ...
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavListeleMultiTur(j);
                }
            }
            catch (Exception)
            {
