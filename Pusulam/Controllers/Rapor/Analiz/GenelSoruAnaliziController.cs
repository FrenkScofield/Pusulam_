...
{
    [GzipCompression]
    public class GenelSoruAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.GenelSoruAnalizi;
        public Object GenelSoruAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinavAnalizi.GenelSoruAnalizi(j);
                }
            }
            catch (Exception)
            {
