...
{
    [GzipCompression]
    public class SinavKonuAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.SinavKonuAnalizi;
        public Object SinavKonuAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinavAnalizi.SinavKonuAnalizi(j);
                }
            }
            catch (Exception)
            {
