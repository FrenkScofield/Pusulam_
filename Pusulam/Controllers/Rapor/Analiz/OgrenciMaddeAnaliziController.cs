...
{
    [GzipCompression]
    public class OgrenciMaddeAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OgrenciMaddeAnalizi;

        public Object OgrenciMaddeAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinavAnalizi.OgrenciMaddeAnalizi(j);
                }
            }
            catch (Exception)
            {
