...
{
    [GzipCompression]
    public class MaddeFrekansAnaliziController : ApiController
    {
        internal int ID_MENU = (int)EMenu.MaddeFrekansAnalizi;
        public Object MaddeFrekansAnalizi(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinavAnalizi.MaddeFrekansAnalizi(j);
                }
            }
            catch (Exception)
            {
