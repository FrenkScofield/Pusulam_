...
namespace Pusulam.Controllers.Rapor.OgrenciBelge
{
    [GzipCompression]
    public class OgrenciBelgeGelisimRaporuLSController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OgrenciBelgeGelisimRaporuLS;
