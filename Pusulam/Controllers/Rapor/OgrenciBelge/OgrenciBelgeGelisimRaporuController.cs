...
{
    [GzipCompression]
    public class OgrenciBelgeGelisimRaporuController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OgrenciBelgeGelisimRaporu;
        ...
        public Object SinavListelebyGrup(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavListelebyGrup(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavListelebyGrupCoklu(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavListelebyGrupCoklu(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavTuruListeleGrubaGore(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavTuruListeleGrubaGore(j);
                }
            }
            catch (Exception)
            {
