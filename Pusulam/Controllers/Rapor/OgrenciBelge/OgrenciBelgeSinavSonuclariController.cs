...
{
    [GzipCompression]
    public class OgrenciBelgeSinavSonuclariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OgrenciBelgeSinavSonuclari;

        public Object SinavSonuclari(JObject j)
        {
            try
            {
