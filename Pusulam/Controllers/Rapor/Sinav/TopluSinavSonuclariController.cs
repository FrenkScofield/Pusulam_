...
{
    [GzipCompression]
    public class TopluSinavSonuclariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.TopluSinavSonuclari;
        ...
        public Object SinavListele(JObject j)
        {
            try
            {
                ...
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavListeleDegerlendirilmis(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object OgrenciListeleMultiSinif(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DOgrenci.ID_MENU = ID_MENU;
                    return c.DOgrenci.OgrenciListeleMultiSinif(j);
                }
            }
            catch (Exception)
            {
