...
{
    [GzipCompression]
    public class SinavIstatistikController : ApiController
    {
        internal int ID_MENU = (int)EMenu.SinavIstatistik;
        ...
        public Object SinavIstatistik(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinavIstatistik.ID_MENU = ID_MENU;
                    return c.DSinavIstatistik.SinavIstatistikGetir(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavDetayGetir(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinavIstatistik.ID_MENU = ID_MENU;
                    return c.DSinavIstatistik.SinavDetayGetir(j);
                }
            }
            catch (Exception)
            {
