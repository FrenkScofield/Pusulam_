...
{
    [GzipCompression]
    public class OkulNetPuanOrtalamalariController:ApiController
    {
        internal int ID_MENU = (int)EMenu.OkulNetPuanOrtalamalari;

        public Object OkulNetPuanOrtalamalari(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DOkulNetPuanOrtalamalari.ID_MENU = ID_MENU;
                    return c.DOkulNetPuanOrtalamalari.OkulNetPuanOrtalamalari(j);
                }
            }
            catch(Exception)
            {
        ...
        public Object SubeListelebyKullanici(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSube.SubeListeleTumu(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object Kademe3ListeleMultiSube(JObject j)
        {
            try
            {
                ...
                {
                    c.DGrup.ID_MENU = ID_MENU;
                    return c.DGrup.Kademe3ListeleMultiSubeYetkisiz(j);
                }
            }
            catch (Exception)
            {
