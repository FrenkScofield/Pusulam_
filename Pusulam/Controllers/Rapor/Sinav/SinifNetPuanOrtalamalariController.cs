...
{
    [GzipCompression]
    public class SinifNetPuanOrtalamalariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.SinifNetPuanOrtalamalari;
        ...
        public Object SinifNetPuanOrtalamalari(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinav.SinifNetPuanOrtalamalari(j);
                }
            }
            catch(Exception)
            {
