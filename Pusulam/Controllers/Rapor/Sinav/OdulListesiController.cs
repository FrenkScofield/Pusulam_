...
{
    [GzipCompression]
    public class OdulListesiController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OdulListesi;

        public Object OdulListesi(JObject j)
        {
            try
            {
