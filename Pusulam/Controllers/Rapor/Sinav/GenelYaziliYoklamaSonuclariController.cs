...
{
    [GzipCompression]
    public class GenelYaziliYoklamaSonuclariController : ApiController
    {
        internal int ID_MENU = (int)EMenu.GenelYaziliYoklamaSonuclari;
        ...
        public Object YaziliYoklamaSonuclariGetirGenelYeni(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.YaziliYoklamaSonuclariGetirGenelYeni(j);
                }
            }
            catch (Exception)
            {
