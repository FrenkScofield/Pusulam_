...
{
    [GzipCompression]
    public class GenelSinavRaporuController : ApiController
    {
        internal int ID_MENU = (int)EMenu.GenelSinavRaporu;
        
        public Object GenelSinavRaporu(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinav.GenelSinavRaporu(j);
                }
            }
            catch (Exception)
            {
        ...
        public Object SinavTuruListeleTcDonem(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavTuruListeleTcDonem(j);
                }
            }
            catch (Exception)
            {
