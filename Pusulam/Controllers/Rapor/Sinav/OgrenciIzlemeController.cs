...
{
    [GzipCompression]
    public class OgrenciIzlemeController : ApiController
    {
        internal int ID_MENU = (int)EMenu.OgrenciIzleme;

        public Object OgrenciIzleme(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DSinav.OgrenciIzleme(j);
                }
            }
            catch(Exception)
            {
        ...
        public Object SinavTuruDersleriListele(JObject j)
        {
            try
            {
                ...
                {
                    c.DSinav.ID_MENU = ID_MENU;
                    return c.DSinav.SinavTuruDersleriListele(j);
                }
            }
            catch(Exception)
            {
