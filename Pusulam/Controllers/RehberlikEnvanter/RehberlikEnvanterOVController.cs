...
{
    [GzipCompression]
    public class RehberlikEnvanterOVController : ApiController
    {
        internal int ID_MENU = (int)EMenu.RehberlikEnvanterOV;
        public Object RehberlikEnvanterleriGetir(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DRehberlikEnvanter.RehberlikEnvanterleriGetir(j);
                }
            }
            catch (Exception)
            {
