...
{
    [GzipCompression]
    public class KullaniciYetkilendirmeController : ApiController
    {
        internal int ID_MENU = (int)EMenu.KullaniciYetkilendirme;
        ...
        public Object MenuListele(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    ...
                    return c.DMenu.KullaniciMenuListelebyYetki(j);
                }
            }
            catch (Exception ex)
            {
        ...
        public Object KullaniciMenuKaydet(JObject j)
        {
            try
            {
                using (Channel c = new Channel())
                {
                    c.DKullaniciYetki.ID_MENU = ID_MENU;
                    return c.DKullaniciYetki.KullaniciMenuKaydet(j);
                }
            }
            catch (Exception ex)
            {
