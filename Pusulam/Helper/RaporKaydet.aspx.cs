...
{
    public partial class RaporKaydet : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //string yol = Request.QueryString["raporYol"];
                rapor.Tag = rpr;
                string yol = rpr;
                ...
                else
                {
                    ...
                    using (MemoryStream stream = new MemoryStream())
                    {
                        ...
                        response.BinaryWrite(File.ReadAllBytes(Server.MapPath("/Dosyalar/"+yol+"/" + Oturum + ".zip")));
                        response.Flush();
